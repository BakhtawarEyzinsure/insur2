...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            licenseTypes: "licenseType/getLicenseTypes"
        }),
        nameErrors() {
            const errors = [];
    ...
    methods: {
        ...mapActions({
            ...
            deleteLicenseType: "licenseType/deleteLicenseType"
        }),
        cancel() {
            this.showAdd = false;
            this.$v.$reset();
        ...
        async deletelicenseType(val) {
            this.id = val.id;
            this.name = val.name;
            await this.deleteLicenseType({
                id: this.id,
                name: this.name
            });
            this.showAdd = false;
